...
u32 *ttb_l2 = (void *)0x70100000;//1K地址对齐;
int main(void)
{
    printf("main start\n");
    ...
    *p = 0x11223344;
    ...
    //ttb[0x4] = (0x504<<20)|(0<<18)|(0<<5)|2;   //1M段映射;
    ttb[0x4] = ((u32)ttb_l2 & 0xfffffc00)|(0<<5)|1;   //二级页表映射;
    memset(ttb_l2, 0, 256 * 4);
    ttb_l2[0] = (0x50400<<12)|2;
