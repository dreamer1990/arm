...
int _start(void)
{
	...
	*(U32 *)0x62000018 = (U32)do_Fiq;
	...
	//1.产生一个中断  外部中断 确定触发方式
	//enable_external_irq(25 , TRIGGER_FALLING_EDGE);
	enable_external_irq(25 , TRIGGER_RISING_EDGE);

	GPIO_Init();
	I2C_InitIp(I2C3 , 200000 , 1000);
	...
	//开中断
	Addr[0] = 0x6 ; 
	Data[0] = 0x1 ;   // front back interrupt
	I2C_SendForGeneral(I2C3 , SLAVEADDR, Addr , 1 ,Data , 1 );
